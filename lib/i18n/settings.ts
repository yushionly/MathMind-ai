export const settingsZhCN = {
  settings: {
    ...
    agentDescriptions: {
      ...
      'default-3': '总爱追问为什么，推动大家理解原理',
      'default-4': '故意犯小错，训练全班检查与纠错能力',
      'default-5': '坚持先画图再计算，培养数形结合思维',
      'default-6': '关注数学在生活中的用途，提升学习动机',
    },
    close: '关闭',
    save: '保存',
    // Provider settings
...
export const settingsEnUS = {
  settings: {
    ...
    agentNames: {
      ...
      'default-3': 'Curious Kid',
      'default-4': 'Careless Checker',
      'default-5': 'Visual Sprite',
      'default-6': 'Real-Life Connector',
    },
    agentRoles: {
      teacher: 'Teacher',
      assistant: 'Assistant',
    ...
    agentDescriptions: {
      ...
      'default-3': 'Keeps asking why and how to uncover the math logic',
      'default-4': 'Makes small mistakes on purpose to train error-checking habits',
      'default-5': 'Prefers diagrams and models to solve word problems',
      'default-6': 'Always asks how math is useful in real life',
    },
    close: 'Close',
    save: 'Save',
    // Provider settings
